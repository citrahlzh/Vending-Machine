...
@section('content')
    <div class="min-h-screen bg-gradient-to-b from-[#f7f3ff] via-white to-[#f3f0ff]">
        <div class="px-6 sm:px-10 lg:px-[72px] pt-[40px] sm:pt-[45px] lg:pt-[56px] pb-[32px] lg:pb-[40px]">
            <div class="bg-cover overflow-hidden shadow-[0_24px_60px_rgba(89,42,155,0.18)]">
                <img src="{{ asset('assets/images/ads/ads.jpg') }}" alt="Ads" class="w-full h-[220px] sm:h-[220x] lg:h-[360px]">
            </div>
        </div>
        ...
        <div class="px-6 sm:px-10 lg:px-[72px] pb-[60px] lg:pb-[80px]">
            <div class="flex grid-cols-1 lg:grid-cols-[1fr_360px] gap-[18px] lg:gap-[32px] items-start">
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-[16px] sm:gap-[16px]">
                    @for ($i = 0; $i < 12; $i++)
                        <div class="bg-white rounded-[15px] p-[14px] border border-[#ede8f6] shadow-[0_10px_24px_rgba(41,18,72,0.08)]">
                            <div class="bg-cover h-[120px] w-[100px] rounded-[15px] bg-gradient-to-b from-[#f1ecff] to-[#fff] border border-[#efe6ff] flex items-center justify-center" style="background-image: url('{{ asset('assets/images/products/fruittea_blackcurrant.png') }}');">
                            ...
                            <div class="mt-[12px]">
                                ...
                                <div class="mt-[10px] flex items-center justify-between">
                                    <button id="min-qty" class="h-[28px] w-[28px] rounded-full border border-[#ceb9ee] text-[#5c2a94]">-</button>
                                    <div id="qty" class="text-[12px] font-semibold text-[#2b1a43]">0</div>
                                    <button id="plus-qty" class="h-[28px] w-[28px] rounded-full bg-[#5c2a94] text-white">+</button>
                                </div>
                            </div>
                        </div>
                    @endfor
                ...
                <div class="bg-white rounded-[15px] border border-[#eee5f9] shadow-[0_12px_30px_rgba(60,34,97,0.12)] p-[24px] lg:sticky lg:top-[24px]">
                    ...
                    <div class="mt-[16px] border-t border-[#efe6ff] pt-[16px]">
                        <div class="grid grid-cols-[1fr_40px_80px] text-[12px] font-semibold text-[#5b4a7a] pb-[10px] border-b border-[#f1ecff]">
                            <div>Produk</div>
                        ...
                        <div class="mt-[16px] pt-[12px] border-t border-[#f1ecff] flex items-center justify-between text-[13px] font-semibold text-[#2b1a43]">
                            <div>Total</div>
                            <div>Rp 30.000,-</div>
                        </div>
                    </div>
                    <button id="btn-pay" class="text-sm mt-[24px] w-full h-[44px] rounded-full bg-[#5c2a94] text-white font-semibold">
                        Bayar Sekarang
                    </button>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-[#8b5ad6] via-[#a673e4] to-[#c78ae6] text-white px-6 sm:px-10 lg:px-[72px] py-[20px] lg:py-[24px]">
    ...
    <div id="modal-pay" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 p-[24px]">
        <div class="bg-white w-full max-w-[420px] rounded-[20px] p-[24px] shadow-[0_24px_60px_rgba(0,0,0,0.25)]">
            ...
            <div class="mt-[16px] mx-auto h-[220px] w-[220px] rounded-[16px] border border-[#e9dcf9] bg-gradient-to-br from-[#f6f0ff] to-white flex items-center justify-center">
    ...
    <div id="modal-success" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 p-[24px]">
        <div class="bg-white w-full max-w-[420px] rounded-[20px] p-[24px] text-center shadow-[0_24px_60px_rgba(0,0,0,0.25)]">
            <div class="mx-auto h-[72px] w-[72px] rounded-full bg-[#e8dcff] flex items-center justify-center text-[#5c2a94] text-[24px] font-bold">OK</div>
            ...
            <button id="btn-close-success" class="mt-[18px] w-full h-[40px] rounded-full bg-[#5c2a94] text-white font-semibold">Tutup</button>
        </div>
    </div>
@endsection
